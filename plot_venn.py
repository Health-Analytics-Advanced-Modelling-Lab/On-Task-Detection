...
def plot_venn(preds, title, name):
    venn(preds,  fontsize=20, figsize=(20, 10))
    plt.title(title)
    plt.savefig(name)
    plt.show()
...
if __name__=="__main__":   
    ...
    ###########################################################################
    ### rest venn diagram
    face_rest_t = 'Rest sets (video images)' 
    preds_f = {
    "VGG video images": set(vgg_pred_f[0]),
    "SVM video images": set(svm_pred_f[0]),
    "XGBoost video images": set(xgboost_pred_f[0]),
...
#    '1D CNN ECG': set(cnn_pred_e[0]),
    ...
    ###########################################################################
    ### focus venn diagram
    face_rest_t = 'Focus sets (video images)' 
    preds_f = {
    "VGG video images": set(vgg_pred_f[1]),
    "SVM video images": set(svm_pred_f[1]),
    "XGBoost video images": set(xgboost_pred_f[1]),
